...
exports.exportFacultyCSV = (req, res) => {
    ...
    const query = `
        ...
        ${whereClause}
        GROUP BY u.faculty_id, u.faculty_name, u.email, u.scopus_id, u.docs_count, u.citations, u.h_index
    ...
    db.query(query, params, (err, results) => {
        ...
        try {
            const csv = new Parser({
                fields: ['faculty_id', 'faculty_name', 'email', 'scopus_id', 'docs_count', 'citations', 'h_index', 'sdgs', 'filtered_docs'],
                excelStrings: true
            }).parse(results);
