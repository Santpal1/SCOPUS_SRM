...
export default function ResearchDashboard() {
  ...
  // Aggregate Yearly Data for 3-Year View
    ...
    <div className={style.container}>
      ...
      <div className={style.dashboard}>
        ...
        <div className={style.topAuthor}>
          <h3>
            Top {topAuthors.length > 1 ? "Authors" : "Author"} ({timeframe === "6m" ? "Last 6 Months" : timeframe === "1y" ? "Last 1 Year" : "Last 2 Years"}):  
            {authorNames} {publicationCount ? `(${publicationCount} publications)` : "No data available"}
          </h3>
        </div>
