...
const CombinedSDGDashboard: React.FC = () => {
    ...
    return (
        <div style={{ padding: '1rem', width: '100%', maxWidth: '1300px', margin: 'auto' }}>
            ...
            <div style={{
                ...
                marginBottom: '3rem',
                padding: '0.5rem', // extra space around chart
                overflow: 'visible', // allow hoverOffset pop-out to show
                position: 'relative', // keep tooltip positioning correct
            }}>
                <div style={{
                    width: 400,
                    height: 400,
                    overflow: 'visible', // prevent clipping within chart canvas container
                    position: 'relative'
                }}>
                    <Pie
                        ref={chartRef}
                        ...
                        options={{
                            ...
                            layout: {
                                padding: 20 // optional internal padding
                            },
                            plugins: {
            ...
            <div style={{
                ...
                {chartLabels.map((label, i) => (
                    <div key={label}>
                        {/* Only this inner div is interactive */}
                        <div
